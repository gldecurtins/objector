    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor_status', models.PositiveSmallIntegerField(choices=[(10, 'alert'), (20, 'warning'), (30, 'normal')], verbose_name='sensor status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='journal_task', to='maintenance.task', verbose_name='task')),
            ],
            options={
                'abstract': False,
            },
