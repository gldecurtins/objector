# Generated by Django 4.0.4 on 2022-06-04 16:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('sensor', 'Sensor'), ('task', 'Task'), ('object', 'Object'), ('location', 'Location')], max_length=8, verbose_name='Source')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to=maintenance.models.document_file_upload_handler, verbose_name='File')),
                ('type', models.CharField(choices=[('manual', 'Manual'), ('receipt', 'Receipt'), ('warranty', 'Warranty')], max_length=8, verbose_name='Type')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='document_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='document_object', to='inventory.object', verbose_name='Object')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='document_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
            ],
            options={
