    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor_value', models.CharField(blank=True, max_length=200, null=True, verbose_name='Sensor value')),
                ('amber_value', models.CharField(blank=True, max_length=200, null=True, verbose_name='Warning value')),
                ('red_value', models.CharField(blank=True, max_length=200, null=True, verbose_name='Alert value')),
